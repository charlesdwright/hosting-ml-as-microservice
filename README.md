The Hello World of ML, a simple sentiment analysis algo trained on a library of movie reviews using Python libraries, with a dash of Flask and served to-go in a Docker container.
